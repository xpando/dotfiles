...
require('lazy').setup({
  ...
  -- Auto install foramtters and linters and other tools with Mason
...
vim.keymap.set('n', '<leader>tn', '<cmd>Neotest jump next<CR>', { desc = '[T]est Jump [N]ext' })
vim.keymap.set('n', '<leader>tp', '<cmd>Neotest jump prev<CR>', { desc = '[T]est Jump [P]revious' })
vim.keymap.set('n', '<leader>to', '<cmd>Neotest output-panel<CR>', { desc = '[T]est [O]output' })

-- Don't show linter errors in the editor (view with the above diagnostics keymap)
