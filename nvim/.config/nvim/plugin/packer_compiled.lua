...
_G.packer_plugins = {
  ...
  onehalf = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/onehalf/vim/",
...
vim.o.runtimepath = vim.o.runtimepath .. ",/home/david/.local/share/nvim/site/pack/packer/start/onehalf/vim/"
